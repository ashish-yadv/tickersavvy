...
// Types import:
import { previousSixYearsAnnualBalanceSheetReports } from '@/app/lib/definitions';

const BALANCE_SHEET = ({ balanceSheetData }) => {
    ...
    return (
        <div className={`w-full`}>
            <Bar data={activeTab === 'annually' ? balanceSheetData.annually : balanceSheetData.quaterly} />
